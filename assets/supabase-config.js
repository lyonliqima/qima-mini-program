...
window.SUPABASE_CONFIG = {
  ...
  // NVIDIA Whisper ASR (Riva gRPC) — hosted on Vercel Python serverless
  asrEndpoint: 'https://qima-mini-program.vercel.app/api/transcribe',
  // Multimodal order parsing (voice + OCR + docs) — product labels → form fields
  parseEndpoint: 'https://qima-mini-program.vercel.app/api/parse',
  parseEndpointFallback: 'https://qima-mini-program.vercel.app/api/parse-order'
};
